...
import com.juaracoding.pcmspringbootcsr.dto.AksesDTO;
...
public class AksesService implements IService<Akses> {
    ...
    public ResponseEntity<Object> find(Pageable pageable, String columFirst, String valueFirst, HttpServletRequest request) {
        ...
        List<AksesDTO> listAkseDTO = null;
        ...
        try
        {
            ...
            listAkseDTO = modelMapper.map(listAkses, new TypeToken<List<AksesDTO>>() {}.getType());
            mapResult = transformToDTO.transformObject(objectMapper,listAkseDTO,pageAkses,listSearchParamDTO,columFirst,valueFirst,ltDivisiOptDTO,ltMenuOptDTO);
